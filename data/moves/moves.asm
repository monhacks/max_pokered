...
; Characteristics of each move.
	...
	move VICEGRIP,     NO_ADDITIONAL_EFFECT,        60, NORMAL,       100, 30
	...
	move GUST,         NO_ADDITIONAL_EFFECT,        50, FLYING,        90, 30
	...
	move BIND,         TRAPPING_EFFECT,             35, NORMAL,        65, 10
	move SLAM,         NO_ADDITIONAL_EFFECT,        80, NORMAL,        85, 20
	move VINE_WHIP,    NO_ADDITIONAL_EFFECT,        45, GRASS,        100, 35
	move STOMP,        FLINCH_SIDE_EFFECT2,         65, NORMAL,       100, 20
	move DOUBLE_KICK,  ATTACK_TWICE_EFFECT,         30, FIGHTING,     100, 30
	move MEGA_KICK,    NO_ADDITIONAL_EFFECT,       120, FIGHTING,      75, 10
	move JUMP_KICK,    JUMP_KICK_EFFECT,            90, FIGHTING,      95, 15
	move ROLLING_KICK, FLINCH_SIDE_EFFECT2,         65, FIGHTING,      85, 20
	move SAND_ATTACK,  ACCURACY_DOWN1_EFFECT,        0, GROUND,       100, 15
	move HEADBUTT,     FLINCH_SIDE_EFFECT2,         75, NORMAL,       100, 20
	move HORN_ATTACK,  NO_ADDITIONAL_EFFECT,        65, NORMAL,       100, 25
	move FURY_ATTACK,  TWO_TO_FIVE_ATTACKS_EFFECT,  15, NORMAL,        90, 25
	move HORN_DRILL,   OHKO_EFFECT,                  1, NORMAL,        50,  5
	move TACKLE,       NO_ADDITIONAL_EFFECT,        50, NORMAL,        90, 30
	move BODY_SLAM,    PARALYZE_SIDE_EFFECT2,       85, NORMAL,       100, 15
	move WRAP,         TRAPPING_EFFECT,             15, NORMAL,        70, 15
	...
	move PIN_MISSILE,  TWO_TO_FIVE_ATTACKS_EFFECT,  20, BUG,           90, 15
	...
	move SUPERSONIC,   CONFUSION_EFFECT,             0, NORMAL,        60, 35
	move SONICBOOM,    SPECIAL_DAMAGE_EFFECT,        1, NORMAL,        90, 25
	move DISABLE,      DISABLE_EFFECT,               0, NORMAL,        75, 25
	move ACID,         DEFENSE_DOWN_SIDE_EFFECT,    70, POISON,        90, 20
	move EMBER,        BURN_SIDE_EFFECT1,           40, FIRE,         100, 30
	move FLAMETHROWER, BURN_SIDE_EFFECT1,           95, FIRE,         100, 10
	move MIST,         MIST_EFFECT,                  0, ICE,          100, 30
	move WATER_GUN,    NO_ADDITIONAL_EFFECT,        40, WATER,        100, 35
	...
	move SUBMISSION,   RECOIL_EFFECT,               95, FIGHTING,      90, 20
	...
	move FIRE_SPIN,    TRAPPING_EFFECT,             30, FIRE,          65, 10
	...
	move ROCK_THROW,   NO_ADDITIONAL_EFFECT,        50, ROCK,          85, 30
	move EARTHQUAKE,   NO_ADDITIONAL_EFFECT,       100, GROUND,       100, 10
	move FISSURE,      OHKO_EFFECT,                  1, GROUND,        50,  5
	move DIG,          CHARGE_EFFECT,               80, GROUND,       100, 20
	move TOXIC,        POISON_EFFECT,                0, POISON,        90, 15
	...
	move HYPNOSIS,     SLEEP_EFFECT,                 0, PSYCHIC_TYPE,  60, 25
	move MEDITATE,     ATTACK_UP1_EFFECT,            0, PSYCHIC_TYPE, 100, 30
	move AGILITY,      SPEED_UP2_EFFECT,             0, PSYCHIC_TYPE, 100, 15
	move QUICK_ATTACK, NO_ADDITIONAL_EFFECT,        40, NORMAL,       100, 30
	move RAGE,         RAGE_EFFECT,                 45, NORMAL,       100, 30
	...
	move SCREECH,      DEFENSE_DOWN2_EFFECT,         0, NORMAL,       100, 25
	move DOUBLE_TEAM,  EVASION_UP1_EFFECT,           0, NORMAL,       100, 15
	move RECOVER,      HEAL_EFFECT,                  0, PSYCHIC_TYPE, 100, 15
	...
	move EGG_BOMB,     NO_ADDITIONAL_EFFECT,       110, NORMAL,        80, 10
	move LICK,         PARALYZE_SIDE_EFFECT2,       40, GHOST,        100, 30
	move SMOG,         POISON_SIDE_EFFECT2,         50, POISON,        80, 25
	move SLUDGE,       POISON_SIDE_EFFECT2,         65, POISON,       100, 20
	move BONE_CLUB,    FLINCH_SIDE_EFFECT1,         65, GROUND,        85, 20
	move FIRE_BLAST,   BURN_SIDE_EFFECT2,          120, FIRE,          85,  5
	move WATERFALL,    NO_ADDITIONAL_EFFECT,        80, WATER,        100, 20
	move CLAMP,        TRAPPING_EFFECT,             30, WATER,         65, 10
	move SWIFT,        SWIFT_EFFECT,                60, NORMAL,       100, 25
	move SKULL_BASH,   CHARGE_EFFECT,              120, NORMAL,       100, 10
	move SPIKE_CANNON, TWO_TO_FIVE_ATTACKS_EFFECT,  25, NORMAL,       100, 10
	...
	move HI_JUMP_KICK, JUMP_KICK_EFFECT,           110, FIGHTING,      90, 10
	move GLARE,        PARALYZE_EFFECT,              0, NORMAL,        90, 25
	move DREAM_EATER,  DREAM_EATER_EFFECT,         100, PSYCHIC_TYPE, 100, 15
	move POISON_GAS,   POISON_EFFECT,                0, POISON,        60, 40
	move BARRAGE,      TWO_TO_FIVE_ATTACKS_EFFECT,  20, NORMAL,        85, 15
	move LEECH_LIFE,   DRAIN_HP_EFFECT,             40, BUG,          100, 30
	...
	move PSYWAVE,      SPECIAL_DAMAGE_EFFECT,        1, PSYCHIC_TYPE,  90, 30
	move SPLASH,       SPLASH_EFFECT,                0, NORMAL,       100, 40
	move ACID_ARMOR,   DEFENSE_UP2_EFFECT,           0, POISON,       100, 20
	move CRABHAMMER,   NO_ADDITIONAL_EFFECT,        95, WATER,         85, 10
	move EXPLOSION,    EXPLODE_EFFECT,             250, NORMAL,       100,  5
	move FURY_SWIPES,  TWO_TO_FIVE_ATTACKS_EFFECT,  18, NORMAL,        85, 20
	move BONEMERANG,   ATTACK_TWICE_EFFECT,         60, GROUND,        85, 10
	move REST,         HEAL_EFFECT,                  0, PSYCHIC_TYPE, 100, 15
	move ROCK_SLIDE,   NO_ADDITIONAL_EFFECT,        80, ROCK,          90, 20
	move HYPER_FANG,   FLINCH_SIDE_EFFECT1,         80, NORMAL,        90, 20
	move SHARPEN,      ATTACK_UP1_EFFECT,            0, NORMAL,       100, 35
